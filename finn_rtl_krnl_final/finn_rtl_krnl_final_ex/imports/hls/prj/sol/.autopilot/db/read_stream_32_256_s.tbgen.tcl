set moduleName read_stream_32_256_s
set isTopModule 0
...
set C_modelName {read_stream<32, 256>}
...
set portList { 
	...
	{ acc_data_V_read sc_in sc_lv 256 signal 3 } 
...
set Spec2ImplPortList { 
	s_axis_V_data_V { axis {  { axis01_TDATA in_data 0 32 }  { axis01_TVALID in_vld 0 1 } } }
