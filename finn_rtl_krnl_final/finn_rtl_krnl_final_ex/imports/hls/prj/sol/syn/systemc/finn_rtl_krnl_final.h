...
#ifndef _finn_rtl_krnl_final_HH_
#define _finn_rtl_krnl_final_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "example_stream_plus1_32_256_s.h"
#include "finn_rtl_krnl_final_control_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_CONTROL_ADDR_WIDTH = 4,
         unsigned int C_S_AXI_CONTROL_DATA_WIDTH = 32>
struct finn_rtl_krnl_final : public sc_module {
    ...
    // Module declarations
    finn_rtl_krnl_final(sc_module_name name);
    SC_HAS_PROCESS(finn_rtl_krnl_final);
    ...
    finn_rtl_krnl_final_control_s_axi<C_S_AXI_CONTROL_ADDR_WIDTH,C_S_AXI_CONTROL_DATA_WIDTH>* finn_rtl_krnl_final_control_s_axi_U;
    example_stream_plus1_32_256_s* grp_example_stream_plus1_32_256_s_fu_38;
    regslice_both<256>* regslice_both_axis00_V_data_V_U;
    regslice_both<32>* regslice_both_axis00_V_keep_V_U;
    regslice_both<1>* regslice_both_axis00_V_last_V_U;
    regslice_both<32>* regslice_both_axis01_V_data_V_U;
    regslice_both<4>* regslice_both_axis01_V_keep_V_U;
    regslice_both<1>* regslice_both_axis01_V_last_V_U;
    sc_signal< sc_logic > ap_rst_reg_2;
    sc_signal< sc_logic > ap_rst_reg_1;
    sc_signal< sc_logic > ap_rst_n_inv;
    sc_signal< sc_logic > grp_example_stream_plus1_32_256_s_fu_38_ap_start;
    sc_signal< sc_logic > grp_example_stream_plus1_32_256_s_fu_38_ap_done;
    sc_signal< sc_logic > grp_example_stream_plus1_32_256_s_fu_38_ap_idle;
    sc_signal< sc_logic > grp_example_stream_plus1_32_256_s_fu_38_ap_ready;
    sc_signal< sc_logic > grp_example_stream_plus1_32_256_s_fu_38_axis01_TREADY;
    sc_signal< sc_lv<256> > grp_example_stream_plus1_32_256_s_fu_38_axis00_TDATA;
    sc_signal< sc_logic > grp_example_stream_plus1_32_256_s_fu_38_axis00_TVALID;
    sc_signal< sc_logic > grp_example_stream_plus1_32_256_s_fu_38_axis00_TREADY;
    sc_signal< sc_lv<32> > grp_example_stream_plus1_32_256_s_fu_38_axis00_TKEEP;
    sc_signal< sc_lv<1> > grp_example_stream_plus1_32_256_s_fu_38_axis00_TLAST;
    sc_signal< sc_logic > grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg;
    ...
    sc_signal< sc_lv<32> > axis01_TDATA_int;
    ...
    sc_signal< sc_lv<4> > axis01_TKEEP_int;
    ...
    void thread_grp_example_stream_plus1_32_256_s_fu_38_ap_start();
    void thread_grp_example_stream_plus1_32_256_s_fu_38_axis00_TREADY();
