...
const sc_logic finn_rtl_krnl_final::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic finn_rtl_krnl_final::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<4> finn_rtl_krnl_final::ap_ST_fsm_state1 = "1";
const sc_lv<4> finn_rtl_krnl_final::ap_ST_fsm_state2 = "10";
const sc_lv<4> finn_rtl_krnl_final::ap_ST_fsm_state3 = "100";
const sc_lv<4> finn_rtl_krnl_final::ap_ST_fsm_state4 = "1000";
const int finn_rtl_krnl_final::C_S_AXI_DATA_WIDTH = "100000";
const sc_lv<32> finn_rtl_krnl_final::ap_const_lv32_1 = "1";
const sc_lv<32> finn_rtl_krnl_final::ap_const_lv32_2 = "10";
const sc_lv<32> finn_rtl_krnl_final::ap_const_lv32_3 = "11";
const bool finn_rtl_krnl_final::ap_const_boolean_1 = true;

finn_rtl_krnl_final::finn_rtl_krnl_final(sc_module_name name) : sc_module(name), mVcdFile(0) {
    finn_rtl_krnl_final_control_s_axi_U = new finn_rtl_krnl_final_control_s_axi<C_S_AXI_CONTROL_ADDR_WIDTH,C_S_AXI_CONTROL_DATA_WIDTH>("finn_rtl_krnl_final_control_s_axi_U");
    finn_rtl_krnl_final_control_s_axi_U->AWVALID(s_axi_control_AWVALID);
    finn_rtl_krnl_final_control_s_axi_U->AWREADY(s_axi_control_AWREADY);
    finn_rtl_krnl_final_control_s_axi_U->AWADDR(s_axi_control_AWADDR);
    finn_rtl_krnl_final_control_s_axi_U->WVALID(s_axi_control_WVALID);
    finn_rtl_krnl_final_control_s_axi_U->WREADY(s_axi_control_WREADY);
    finn_rtl_krnl_final_control_s_axi_U->WDATA(s_axi_control_WDATA);
    finn_rtl_krnl_final_control_s_axi_U->WSTRB(s_axi_control_WSTRB);
    finn_rtl_krnl_final_control_s_axi_U->ARVALID(s_axi_control_ARVALID);
    finn_rtl_krnl_final_control_s_axi_U->ARREADY(s_axi_control_ARREADY);
    finn_rtl_krnl_final_control_s_axi_U->ARADDR(s_axi_control_ARADDR);
    finn_rtl_krnl_final_control_s_axi_U->RVALID(s_axi_control_RVALID);
    finn_rtl_krnl_final_control_s_axi_U->RREADY(s_axi_control_RREADY);
    finn_rtl_krnl_final_control_s_axi_U->RDATA(s_axi_control_RDATA);
    finn_rtl_krnl_final_control_s_axi_U->RRESP(s_axi_control_RRESP);
    finn_rtl_krnl_final_control_s_axi_U->BVALID(s_axi_control_BVALID);
    finn_rtl_krnl_final_control_s_axi_U->BREADY(s_axi_control_BREADY);
    finn_rtl_krnl_final_control_s_axi_U->BRESP(s_axi_control_BRESP);
    finn_rtl_krnl_final_control_s_axi_U->ACLK(ap_clk);
    finn_rtl_krnl_final_control_s_axi_U->ARESET(ap_rst_n_inv);
    finn_rtl_krnl_final_control_s_axi_U->ACLK_EN(ap_var_for_const0);
    grp_example_stream_plus1_32_256_s_fu_38 = new example_stream_plus1_32_256_s("grp_example_stream_plus1_32_256_s_fu_38");
    grp_example_stream_plus1_32_256_s_fu_38->ap_clk(ap_clk);
    grp_example_stream_plus1_32_256_s_fu_38->ap_rst(ap_rst_n_inv);
    grp_example_stream_plus1_32_256_s_fu_38->ap_start(grp_example_stream_plus1_32_256_s_fu_38_ap_start);
    grp_example_stream_plus1_32_256_s_fu_38->ap_done(grp_example_stream_plus1_32_256_s_fu_38_ap_done);
    grp_example_stream_plus1_32_256_s_fu_38->ap_idle(grp_example_stream_plus1_32_256_s_fu_38_ap_idle);
    grp_example_stream_plus1_32_256_s_fu_38->ap_ready(grp_example_stream_plus1_32_256_s_fu_38_ap_ready);
    grp_example_stream_plus1_32_256_s_fu_38->axis01_TDATA(axis01_TDATA_int);
    grp_example_stream_plus1_32_256_s_fu_38->axis01_TVALID(axis01_TVALID_int);
    grp_example_stream_plus1_32_256_s_fu_38->axis01_TREADY(grp_example_stream_plus1_32_256_s_fu_38_axis01_TREADY);
    grp_example_stream_plus1_32_256_s_fu_38->axis01_TKEEP(axis01_TKEEP_int);
    grp_example_stream_plus1_32_256_s_fu_38->axis01_TLAST(axis01_TLAST_int);
    grp_example_stream_plus1_32_256_s_fu_38->axis00_TDATA(grp_example_stream_plus1_32_256_s_fu_38_axis00_TDATA);
    grp_example_stream_plus1_32_256_s_fu_38->axis00_TVALID(grp_example_stream_plus1_32_256_s_fu_38_axis00_TVALID);
    grp_example_stream_plus1_32_256_s_fu_38->axis00_TREADY(grp_example_stream_plus1_32_256_s_fu_38_axis00_TREADY);
    grp_example_stream_plus1_32_256_s_fu_38->axis00_TKEEP(grp_example_stream_plus1_32_256_s_fu_38_axis00_TKEEP);
    grp_example_stream_plus1_32_256_s_fu_38->axis00_TLAST(grp_example_stream_plus1_32_256_s_fu_38_axis00_TLAST);
    regslice_both_axis00_V_data_V_U = new regslice_both<256>("regslice_both_axis00_V_data_V_U");
    regslice_both_axis00_V_data_V_U->ap_clk(ap_clk);
    regslice_both_axis00_V_data_V_U->ap_rst(ap_rst_n_inv);
    regslice_both_axis00_V_data_V_U->data_in(grp_example_stream_plus1_32_256_s_fu_38_axis00_TDATA);
    regslice_both_axis00_V_data_V_U->vld_in(grp_example_stream_plus1_32_256_s_fu_38_axis00_TVALID);
    ...
    regslice_both_axis00_V_keep_V_U = new regslice_both<32>("regslice_both_axis00_V_keep_V_U");
    regslice_both_axis00_V_keep_V_U->ap_clk(ap_clk);
    regslice_both_axis00_V_keep_V_U->ap_rst(ap_rst_n_inv);
    regslice_both_axis00_V_keep_V_U->data_in(grp_example_stream_plus1_32_256_s_fu_38_axis00_TKEEP);
    regslice_both_axis00_V_keep_V_U->vld_in(grp_example_stream_plus1_32_256_s_fu_38_axis00_TVALID);
    ...
    regslice_both_axis00_V_last_V_U->data_in(grp_example_stream_plus1_32_256_s_fu_38_axis00_TLAST);
    regslice_both_axis00_V_last_V_U->vld_in(grp_example_stream_plus1_32_256_s_fu_38_axis00_TVALID);
    ...
    regslice_both_axis01_V_data_V_U = new regslice_both<32>("regslice_both_axis01_V_data_V_U");
    ...
    regslice_both_axis01_V_keep_V_U = new regslice_both<4>("regslice_both_axis01_V_keep_V_U");
    ...
    sensitive << ( grp_example_stream_plus1_32_256_s_fu_38_axis01_TREADY );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_grp_example_stream_plus1_32_256_s_fu_38_ap_start);
    sensitive << ( grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg );

    SC_METHOD(thread_grp_example_stream_plus1_32_256_s_fu_38_axis00_TREADY);
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( axis00_TREADY_int );

    SC_METHOD(thread_ap_NS_fsm);
    sensitive << ( grp_example_stream_plus1_32_256_s_fu_38_ap_done );
    sensitive << ( ap_CS_fsm );
    sensitive << ( ap_CS_fsm_state3 );
    ...
    grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg = SC_LOGIC_0;
    ap_CS_fsm = "0001";
    static int apTFileNum = 0;
    stringstream apTFilenSS;
    apTFilenSS << "finn_rtl_krnl_final_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_ap_start, "grp_example_stream_plus1_32_256_s_fu_38_ap_start");
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_ap_done, "grp_example_stream_plus1_32_256_s_fu_38_ap_done");
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_ap_idle, "grp_example_stream_plus1_32_256_s_fu_38_ap_idle");
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_ap_ready, "grp_example_stream_plus1_32_256_s_fu_38_ap_ready");
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_axis01_TREADY, "grp_example_stream_plus1_32_256_s_fu_38_axis01_TREADY");
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_axis00_TDATA, "grp_example_stream_plus1_32_256_s_fu_38_axis00_TDATA");
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_axis00_TVALID, "grp_example_stream_plus1_32_256_s_fu_38_axis00_TVALID");
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_axis00_TREADY, "grp_example_stream_plus1_32_256_s_fu_38_axis00_TREADY");
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_axis00_TKEEP, "grp_example_stream_plus1_32_256_s_fu_38_axis00_TKEEP");
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_axis00_TLAST, "grp_example_stream_plus1_32_256_s_fu_38_axis00_TLAST");
    sc_trace(mVcdFile, grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg, "grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg");
    ...
    mHdltvinHandle.open("finn_rtl_krnl_final.hdltvin.dat");
    mHdltvoutHandle.open("finn_rtl_krnl_final.hdltvout.dat");
}

finn_rtl_krnl_final::~finn_rtl_krnl_final() {
    if (mVcdFile) 
    ...
    delete finn_rtl_krnl_final_control_s_axi_U;
    delete grp_example_stream_plus1_32_256_s_fu_38;
...
void finn_rtl_krnl_final::thread_ap_var_for_const0() {
    ap_var_for_const0 = ap_const_logic_1;
}

void finn_rtl_krnl_final::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg = ap_const_logic_0;
    } else {
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
            grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg = ap_const_logic_1;
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_example_stream_plus1_32_256_s_fu_38_ap_ready.read())) {
            grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg = ap_const_logic_0;
        }
    }
}

void finn_rtl_krnl_final::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void finn_rtl_krnl_final::thread_ap_CS_fsm_state3() {
    ap_CS_fsm_state3 = ap_CS_fsm.read()[2];
}

void finn_rtl_krnl_final::thread_ap_CS_fsm_state4() {
    ap_CS_fsm_state4 = ap_CS_fsm.read()[3];
}

void finn_rtl_krnl_final::thread_axis00_TVALID() {
    axis00_TVALID = regslice_both_axis00_V_data_V_U_vld_out.read();
}

void finn_rtl_krnl_final::thread_axis01_TREADY() {
...
void finn_rtl_krnl_final::thread_axis01_TREADY_int() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        axis01_TREADY_int = grp_example_stream_plus1_32_256_s_fu_38_axis01_TREADY.read();
    } else {
        axis01_TREADY_int = ap_const_logic_0;
    }
}

void finn_rtl_krnl_final::thread_grp_example_stream_plus1_32_256_s_fu_38_ap_start() {
    grp_example_stream_plus1_32_256_s_fu_38_ap_start = grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg.read();
}

void finn_rtl_krnl_final::thread_grp_example_stream_plus1_32_256_s_fu_38_axis00_TREADY() {
    grp_example_stream_plus1_32_256_s_fu_38_axis00_TREADY = (ap_CS_fsm_state3.read() & axis00_TREADY_int.read());
}

void finn_rtl_krnl_final::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(grp_example_stream_plus1_32_256_s_fu_38_ap_done.read(), ap_const_logic_1))) {
...
void finn_rtl_krnl_final::thread_hdltv_gen() {
