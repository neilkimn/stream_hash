...
architecture behav of finn_rtl_krnl_final is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "finn_rtl_krnl_final,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.589600,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2405,HLS_SYN_LUT=698,HLS_VERSION=2020_1}";
...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    signal grp_example_stream_plus1_32_256_s_fu_38_ap_start : STD_LOGIC;
    signal grp_example_stream_plus1_32_256_s_fu_38_ap_done : STD_LOGIC;
    signal grp_example_stream_plus1_32_256_s_fu_38_ap_idle : STD_LOGIC;
    signal grp_example_stream_plus1_32_256_s_fu_38_ap_ready : STD_LOGIC;
    signal grp_example_stream_plus1_32_256_s_fu_38_axis01_TREADY : STD_LOGIC;
    signal grp_example_stream_plus1_32_256_s_fu_38_axis00_TDATA : STD_LOGIC_VECTOR (255 downto 0);
    signal grp_example_stream_plus1_32_256_s_fu_38_axis00_TVALID : STD_LOGIC;
    signal grp_example_stream_plus1_32_256_s_fu_38_axis00_TREADY : STD_LOGIC;
    signal grp_example_stream_plus1_32_256_s_fu_38_axis00_TKEEP : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_example_stream_plus1_32_256_s_fu_38_axis00_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg : STD_LOGIC := '0';
    ...
    signal axis01_TDATA_int : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal axis01_TKEEP_int : STD_LOGIC_VECTOR (3 downto 0);
    ...
    component example_stream_plus1_32_256_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component finn_rtl_krnl_final_control_s_axi IS
    generic (
...
begin
    finn_rtl_krnl_final_control_s_axi_U : component finn_rtl_krnl_final_control_s_axi
    generic map (
    ...
    grp_example_stream_plus1_32_256_s_fu_38 : component example_stream_plus1_32_256_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                elsif ((grp_example_stream_plus1_32_256_s_fu_38_ap_ready = ap_const_logic_1)) then 
                    grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (grp_example_stream_plus1_32_256_s_fu_38_ap_done, ap_CS_fsm, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_axis00_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_example_stream_plus1_32_256_s_fu_38_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    axis01_TREADY_int_assign_proc : process(grp_example_stream_plus1_32_256_s_fu_38_axis01_TREADY, ap_CS_fsm_state3)
    begin
    ...
    grp_example_stream_plus1_32_256_s_fu_38_ap_start <= grp_example_stream_plus1_32_256_s_fu_38_ap_start_reg;
    grp_example_stream_plus1_32_256_s_fu_38_axis00_TREADY <= (axis00_TREADY_int and ap_CS_fsm_state3);
end behav;
