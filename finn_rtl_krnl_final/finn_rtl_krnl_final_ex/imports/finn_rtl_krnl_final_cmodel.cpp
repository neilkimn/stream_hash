...
extern "C" void finn_rtl_krnl_final (
    hls::stream< qdma_axis<256,0,0,0> >& axis00,
    hls::stream< qdma_axis<32,0,0,0> >& axis01
) {


    #pragma HLS INTERFACE s_axilite port=return bundle=control
    #pragma HLS INTERFACE ap_ctrl_none port=return
    #pragma HLS INTERFACE axis port=axis00
    #pragma HLS INTERFACE axis port=axis01

// Modify contents below to match the function of the RTL Kernel
    unsigned int data;

  // axis01 plus 1 to axis00 example
  example_stream_plus1<32,256> (axis01,axis00,32);
