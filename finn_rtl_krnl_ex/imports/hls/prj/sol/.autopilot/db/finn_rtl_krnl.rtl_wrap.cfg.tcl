...
set structArgument0 [list 512 0 0 0 ]
set NameSpace0 [list ]
set structIsPacked0 "0"
set DataType0 [list "qdma_axis<512, 0, 0, 0>" "struct qdma_axis" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set structArgument1 [list 512 0 0 0 ]
set NameSpace1 [list ]
set structIsPacked1 "0"
set DataType1 [list "qdma_axis<512, 0, 0, 0>" "struct qdma_axis" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
